<div id="kannada">
	...
	<div class="keys lline tline" id="RU" onclick="InsertText('ೠ')">ೠ</div>
	<div class="keys tline" id="e" onclick="InsertText('ಎ')">ಎ</div>
	<div class="keys tline" id="E" onclick="InsertText('ಏ')">ಏ</div>
	<div class="keys tline" id="ai" onclick="InsertText('ಐ')">ಐ</div>
	<div class="keys tline" id="o" onclick="InsertText('ಒ')">ಒ</div>
	<div class="keys tline" id="O" onclick="InsertText('ಓ')">ಓ</div>
	<div class="keys lline" id="au" onclick="InsertText('ಔ')">ಔ</div>
	<div class="keys " id="M" style="border-bottom: none;" onclick="InsertText('ಂ')">ಂ</div>
	<div class="keys" id="H" style="border-bottom: none;" onclick="InsertText('ಃ')">ಃ</div>
	<div class="keys lline" style="clear: left;" id="ka" onclick="InsertText('ಕ')">ಕ</div>
	...
	<div class="keys tline" id="ha" style="border-bottom: none;" onclick="InsertText('ಹ')">ಹ</div>
	<div class="keys tline" id="La" style="border-bottom: none;" onclick="InsertText('ಳ')">ಳ</div>
	<div class="keys lline" style="clear: left;" id="Akara" onclick="InsertText('ಾ')">ಾ</div>
	<div class="keys" id="ikara" onclick="InsertText('ಿ')">ಿ</div>
	<div class="keys" id="Ikara" onclick="InsertText('ೀ')">ೀ</div>
	<div class="keys" id="ukara" onclick="InsertText('ು')">ು</div>
	<div class="keys" id="Ukara" onclick="InsertText('ೂ')">ೂ</div>
	<div class="keys" id="Rkara" onclick="InsertText('ೃ')">ೃ</div>
	<div class="keys" id="RRkara" onclick="InsertText('ೄ')"> ೄ</div>
	<div class="keys tline" id="ekara" onclick="InsertText('ೆ')">ೆ</div>
	<div class="keys tline" id="Ekara" onclick="InsertText('ೇ')">ೇ</div>
	<div class="keys tline" id="aikara" onclick="InsertText('ೈ')">ೈ</div>
	<div class="keys tline" id="okara" onclick="InsertText('ೊ')">ೊ</div>
	<div class="keys tline" id="Okara" onclick="InsertText('ೋ')">ೋ</div>
	<div class="keys tline" id="aukara" onclick="InsertText('ೌ')">ೌ</div>
	<div class="keys lline" id="halanta" onclick="InsertText('್')">್</div>
</div>
